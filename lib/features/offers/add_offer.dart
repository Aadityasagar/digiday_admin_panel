  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Scaffold(
          appBar: AppBar(
            title: Text("Add New offer", style: headingStyle),
          ),
          body: Padding(
              ...
              child: Column(
                children: [
                 ...
                 const SizedBox(height: 20),
                  Obx(()=> Form(
                    key: _offerController.addOfferFormKey,
                    child: Column(
                      children: [
                        ...
                        _offerController.selectedImage?.value!="" && _offerController.selectedImage?.value!=null ?
                        ...
                        Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),
                            ...
                            child: Padding(
                              ...
                              child:   Container(child: Image.file(File(_offerController.selectedImage!.value!), fit: BoxFit.cover,),
                              ),
                            )
                        ):const SizedBox(),
                        ...
                        Padding(
                          ...
                          child: DefaultButton(
                            text:  _offerController.selectedImage?.value!="" && _offerController.selectedImage?.value!=null ? "Change Image": "Add Image",
                            press: (){
                        ...
                        Padding(
                          ...
                          child: DefaultButton(
                            text: "Continue",
                            press: () {
                              // // if(_businessController?.getBusinessData?.id!=null) {
                              // //   _offerController.validateAndSubmit(_businessController.getBusinessData!.id!);
                              // }
                            },
                          ),
                        ),
