                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      const EdgeInsets.symmetric(horizontal: 20),
                      child: Text(
                        vendorProvider.selectedVendor?.address ?? "",
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      const EdgeInsets.symmetric(horizontal: 20),
                      child: Text(
                        vendorProvider.selectedVendor?.city ?? "",
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      const EdgeInsets.symmetric(horizontal: 20),
                      child: Text(
                        vendorProvider.selectedVendor?.state ?? "",
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      const EdgeInsets.symmetric(horizontal: 20),
                      child: Text(
                        vendorProvider.selectedVendor?.pinCode ?? "",
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      const EdgeInsets.symmetric(horizontal: 20),
                      child: Text(
                        vendorProvider.selectedVendor?.referralCode ?? "",
                      ),
                    ),
                  ],
                ),
